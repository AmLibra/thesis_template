...
In summary, this report has introduced RBMT, a robust framework designed explicitly for testing binary rewriters. 
As a comprehensive platform, RBMT permits large-scale assessments of binary rewriters, while also accommodating a 
...
Linux x86_64 binaries and supports a restricted range of subjects. Consequently, we anticipate future research 
