...
The experiments conducted as part of this research were run on an Intel Core i7-9700K CPU @ 3.60GHz with 16GB of RAM, 
running Ubuntu 20.04 LTS. Each of the three binary rewriters (Zipr, e9patch, and ddisasm) were tested on five different 
subjects: coreutils, libreoffice, mysql, redis, and sqlite. The success rate of the binary rewrites was calculated
based on the number of total tests run and the number of those tests that passed.
